...
public class ShaderProgram {
    ...
    public ShaderProgram(FileBuffer vertexFile, FileBuffer fragmentFile, String... inVariables) {
    ...
    public ShaderProgram(FileBuffer vertexFile, FileBuffer geometryFile, FileBuffer fragmentFile, String... inVariables) {
        int vertexShaderID = loadShader(vertexFile, GL20.GL_VERTEX_SHADER);
